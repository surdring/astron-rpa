...
了解如何创建 InsForge 项目并使用 AI 构建 React 应用

复制页面

了解如何创建 InsForge 项目并使用 Cursor 等 AI 工具构建 React 应用。
...
```
创建一个新的 React 应用，使用 TypeScript 和 Vite。
...
**运动项目组件**位于 `src/components/Sports.tsx`：
