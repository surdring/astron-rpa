...
了解如何创建 InsForge 项目并使用 AI 构建 Next.js 应用

复制页面

了解如何创建 InsForge 项目并使用 Cursor 等 AI 工具构建 Next.js 应用。
...
**InsForge 客户端**位于 `lib/insforge.ts`：
...
[Razorpay 支付 SDK](/sdks/typescript/payments-razorpay)[React](/examples/framework-guides/react)
