...
const { state, executeImmediate } = useAsyncState(() => rpaApi.robots.getComponentDetail(props), null)
...
function handleUpdate() {
  execute(async () => {
    await rpaApi.robots.updateComponent({
      robotId: props.robotId,
      componentId: props.componentId,
