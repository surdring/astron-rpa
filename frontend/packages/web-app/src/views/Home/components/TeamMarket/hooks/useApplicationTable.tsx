...
export function useApplicationTable() {
  ...
  const getApplicationList = async (params): Promise<ITableResponse<any>> => {
    const res = await rpaApi.market.applicationList(params) as { data: ITableResponse<any> }
    return res.data
  }
  ...
  async function handleCancel(record) {
    ...
    await rpaApi.market.cancelApplication({ id: record.id })
  ...
  async function handleDelete(record) {
    ...
    await rpaApi.market.deleteApplication({ id: record.id })
