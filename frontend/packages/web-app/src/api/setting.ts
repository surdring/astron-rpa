...
export async function getApis(params) {
  const res = await rpaApi.http.get<ITableResponse>('/api/rpa-openapi/api-keys/get', params)
...
export function deleteAPI(params) {
  return rpaApi.http.post('/api/rpa-openapi/api-keys/remove', params)
}
...
export async function createAPI(params) {
  const res = await rpaApi.http.post('/api/rpa-openapi/api-keys/create', params)
  return res.data
}
...
export async function getAgentApis(params) {
  const res = await rpaApi.http.get('/api/rpa-openapi/api-keys/get-astron', params)
  return res.data
}
...
export function deleteAgentAPI(id: number) {
  return rpaApi.http.post('/api/rpa-openapi/api-keys/remove-astron', { id })
}
...
export async function createAgentAPI<T>(params: T) {
  const res = await rpaApi.http.post<{ id: number }>('/api/rpa-openapi/api-keys/create-astron', params)
  return res.data
}
...
export async function updateAgentApi<T>(params: T) {
  const res = await rpaApi.http.post<{ id: number }>('/api/rpa-openapi/api-keys/update-astron', params)
  return res.data
}