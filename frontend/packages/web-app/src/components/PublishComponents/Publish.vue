...
async function handleSubmit(): Promise<void> {
  ...
  const res = await rpaApi.robots.publishRobot(lastPublishData)
  ...
  applicationReleaseCheck({
    ...
    // 需要上架申请
    const releaseRes = await rpaApi.market.releaseWithPublish({ robotId: lastPublishData.robotId, robotVersion: lastPublishData.version, name: lastPublishData.name, ...params })
