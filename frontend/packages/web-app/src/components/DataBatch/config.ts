...
export const dateSelectList = [
  ...
  { label: '%Y.%m.%d %H:%M:%S', value: '%Y.%m.%d %H:%M:%S', key: 'y_dot_m_dot_d_hms' },
  ...
  { label: '%Y.%m.%d %H:%M', value: '%Y.%m.%d %H:%M', key: 'y_dot_m_dot_d_hm' },
  ...
  { label: '%m.%d %H:%M:%S', value: '%m.%d %H:%M:%S', key: 'm_dot_d_hms' },
